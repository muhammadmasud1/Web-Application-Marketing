                  ...
                  <main className={style.aboutbanner}>
                    <section className="info-section">
                      <div className="left-part">
                        ...
                        <p>
                          Crafting the digital canvas, one pixel at a time, to
                          bring your vision to life and elevate your online
                          presence with innovative and impactful website design
                          solutions.
                        </p>
